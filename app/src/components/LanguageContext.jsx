...
const translations = {
    en: {
        ...
        welcomeExportTitle: 'Full timetable PDF',
        welcomeExportDesc: 'College by college — every course and section, neat and ready to save or print. Generated on your device.',
        welcomeExportBtn: 'Download General PDF',
        welcomeExporting: 'Generating…',
        welcomeExportHint: 'Landscape A4, one chapter per college.',
    ...
    ar: {
        ...
        welcomeExportTitle: 'الجدول الكامل PDF',
        welcomeExportDesc: 'مرتب كلية بكلية — جميع المقررات والشعب، جاهز للحفظ أو الطباعة ويُنشأ مباشرة على جهازك.',
        welcomeExportBtn: 'حمّل الملف العام',
        welcomeExporting: 'جاري الإنشاء…',
        welcomeExportHint: 'A4 أفقي، فصل لكل كلية.',
